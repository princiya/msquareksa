    ...
    var googleMap = function() {
        if ( $().gmap3 ) {
            $("#flat-map").gmap3({
                ...
                getlatlng:{
                    address: "Maak #902, 1st Street, AL Shams Building#1, Dammam.",
                    callback: function(results) {
                        if ( !results ) return;
                        $(this).gmap3('get').setCenter(new google.maps.LatLng(results[0].geometry.location.lat(27.010605), results[0].geometry.location.lng(49.654476)));
                        $(this).gmap3({
                            marker:{
     ...
     var Brochure = function() {
        $(window).scroll(function() {
            if ( $(this).scrollTop() > 100 ) {
                $('.brochure').addClass('show');
            } else {
                $('.brochure').removeClass('show');
            }
        }); 
